...
class ListViewController: UITableViewController {
    ...
    func callMovieAPI() {
        ...
        do {
            ...
            // (6) Iterator 처리를 하면서 API 데이터를 MovieVO 객체에저장한다.
            for row in movie {
                // 순회 상수를 NSDictinary 타입으로 캐스팅
                ...
                mvo.title = r["mainTitle"] as? String
                mvo.description = r["subTitle"] as? String
                mvo.thumbnail = r["thumbnail"] as? String
                mvo.detail = r["linkUrl"] as? String
                mvo.rating = ((r["rating"] as! NSString).doubleValue)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        /* 방법4: 챕터10, UIImage파싱과정을 callMovieAPI 함수에서 객체에 저장하도록함 여기서는 데이터를 그 객체에서 불러와 대입 */
//        cell.thumbnail.image = row.thumbnailImage
        
        /* 방법4-> 수정: 비동기 방식으로 섬네일 이미지를 읽어옴 */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        NSLog("선택된 행운\(indexPath.row) 번째 행입니다")
    }
