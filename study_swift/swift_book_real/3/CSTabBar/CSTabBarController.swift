...
class CSTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        // 1️⃣ 새로운 탭 바 역할을 할 뷰를 위해 기준 좌표와 크기를 정의합니다.
...
//        let temp = UIImage(named: "menubar-bg-mini")
//        self.csView = UIImageView(image: temp)
        self.csView.frame = CGRect(x: x, y: y, width: width, height: height)
        self.csView.backgroundColor = UIColor(patternImage: UIImage(named: "menubar-bg-mini")!)
